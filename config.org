...
(use-package org
  ...
  (:map global-map
	("C-c a" . 'org-agenda)
	:map org-mode-map
	("C-c C-f h e" . 'org-fold-hide-entry)
	("C-c C-f h a" . 'org-fold-hide-block-all)
	("C-c C-f s e" . 'org-fold-show-entry)
	("C-c C-f s a" . 'org-fold-show-all)))
#+end_src
...
(use-package org-journal
  ...
  :bind
  (:map global-map
	("C-c C-j n e" . org-journal-new-entry)))
#+end_src
...
(use-package org-roam
  ...
  :hook
  ((org-mode . (lambda ()
		 (local-set-key (kbd "C-c C-r t a") 'org-roam-tag-add)
		 (local-set-key (kbd "C-c C-r t r") 'org-roam-tag-remove)
		 (local-set-key (kbd "C-c C-r a a") 'org-roam-alias-add)
		 (local-set-key (kbd "C-c C-r a r") 'org-roam-alias-remove)
		 (local-set-key (kbd "C-c C-r n i") 'org-roam-node-insert))))
  :bind
  (:map global-map
	("C-c C-r n f" . org-roam-node-find)
	("C-c C-r d t" . org-roam-dailies-capture-today))
  :custom
